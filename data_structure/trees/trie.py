...
# Time O(N*avgL) for building, insertion and lookup (# of strs * # of avg word length), S(N*avgL)
# Use cases: autocomplete, spellchecker
# https://sikicode.com/2023/06/05/inverted-index-search-keywords-in-a-list-of-documents/
class TrieNode:
    def __init__(self):
